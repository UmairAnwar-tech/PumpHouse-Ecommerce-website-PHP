...
<form action="updatehelper.php" method="post" style="margin:auto"; >
<div>
    
   Id:
   <br> <input type="text" name="id" id="" placeholder="Id" value="<?php echo($id) ?>">
    </div>
<div>

   name:
   <br> <input type="text" name="Prodname" id="" placeholder="product name" value="<?php echo($name) ?>">
    </div>
    <div>
   price:
   <br> <input type="text" name="price" id="" placeholder="price"  value="<?php echo($price) ?>" >
    </div>
    <div>
  ...
  <br><input type="file" name="img" id="">
   ...
   <div>
  desicrpation: 
  <textarea name="des" id="" cols="30" rows="10" placeholder="desicrpation" ><?php echo($des) ?></textarea>
   </div>
...
<div class="col-md-4 " >
    <h4 style="margin:auto; margin-left:80px; margin-top:100px; color:grey;">Image</h4>
